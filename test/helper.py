...
print commands.getoutput("clang --target=ppc32 -S -emit-llvm -O3 -o %s.o3.ll %s "%(filename,argvs[1]))
print commands.getoutput("clang --target=ppc32 -c -emit-llvm -O3 -o %s.o3.bc %s "%(filename,argvs[1]))
