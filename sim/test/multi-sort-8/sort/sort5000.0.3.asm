...
-1874, data_start, A_POINTER
-2499, data_start, B_POINTER
...
buf2_offset2, bp2, W1
0, A, W1:0
-1, buf2_offset2, buf2_offset2, A_changed_fin

L_B_A:
buf2_offset2, bp2, W2
0, B, W2:0
-1, buf2_offset2, buf2_offset2
...
buf2_offset2, bp2, W3
0, B, W3:0
-1, buf2_offset2, buf2_offset2, B_changed_fin
...
B_changed:
0, POINTER_2: buf-4999, B
A, B, temp, output_A  // temp = A - B, if temp < 0 (B>A): A change, output A
output_B:
0, B, CRIGHT_OUT
// p++
