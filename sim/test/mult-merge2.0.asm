...
A, B, temp, L_B_A
L_A1:0, FLAG1, temp, L_A1
0, A, OUTPUT1
0, -1, FLAG1, A_changed_fin

L_B_A:
L_B1:0, FLAG1, temp, L_B1
0, B, OUTPUT1
0, -1, FLAG1
...
B, A, temp, L_A_B
L_B2:0, FLAG1, temp, L_B2
0, B, OUTPUT1
0, -1, FLAG1, B_changed_fin

L_A_B:
L_A2:0, FLAG1, temp, L_A2
0, A, OUTPUT1
0, -1, FLAG1
...
L_B3:0, FLAG1, temp, L_B3
0, READ_B_5: 0, OUTPUT1
0, -1, FLAG1
-1, B_POINTER, B_POINTER
...
L_A3:0, FLAG1, temp, L_A3
0, READ_A_5: 0, OUTPUT1
0, -1, FLAG1
-1, A_POINTER, A_POINTER
